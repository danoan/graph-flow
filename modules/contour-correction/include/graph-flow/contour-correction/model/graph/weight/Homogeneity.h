#ifndef GRAPH_FLOW_IMAGE_SEGMENTATION_HOMOGENEITY_H
...
class Homogeneity : public GraphFlow::Core::EdgeWeight {
 ...
 public:
  Homogeneity(const cv::Mat &colorImage, double boundaryWeight)
...
#endif  // GRAPH_FLOW_IMAGE_SEGMENTATION_HOMOGENEITY_H
