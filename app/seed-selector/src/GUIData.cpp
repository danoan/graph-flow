...
GUIData::GUIData(const std::string& windowName, const std::string& outputFolder,
    ...
    : windowName(windowName),
      ...
      penWidth(4),
      seedCounter(0),
      _meProbablyForeground(
          RectMouseEvent(this->cvImg, cv::Scalar(255, 0, 0, 0))),
...
void GUIData::set(MouseEventType met) {
  if (met == ProbablyForeground) {
    ...
    throw std::runtime_error("Mouse event type unknown!");
}
...
void GUIData::set(IMouseEvent* met) { _meCurrent = met; }
