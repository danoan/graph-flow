#ifndef GRAPH_FLOW_SEED_SELECTOR_RECTSELECTOR_H
#define GRAPH_FLOW_SEED_SELECTOR_RECTSELECTOR_H
...
class MouseEvent : public IMouseEvent {
 public:
  MouseEvent(const cv::Mat& cvImg, cv::Scalar rectColor = cv::Scalar(255, 0, 0),
...
#endif  // GRAPH_FLOW_SEED_SELECTOR_RECTSELECTOR_H
