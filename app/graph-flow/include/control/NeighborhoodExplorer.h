#ifndef GRAPH_FLOW_APP_GRAPH_FLOW_NeighborhoodExplorer_h
#define GRAPH_FLOW_APP_GRAPH_FLOW_NeighborhoodExplorer_h
...
#endif /* GRAPH_FLOW_APP_GRAPH_FLOW_NeighborhoodExplorer_h */
