...
int main(int argc, char* argv[]) {
  ...
  SummaryFlow::OneImageFlow oif(
      srcImagePath.string(), id.outputFilePath, id.imageExtension,
      id.drawInterval, id.colorScheme, id.iot, id.pixelMaskPath,
      id.dirsMaskPath, id.drawCenterBall, id.radius, id.h);
